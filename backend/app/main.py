...
def fix_database_schema():
    ...
    try:
        ...
        db.execute(text("CREATE INDEX IF NOT EXISTS idx_chat_room_created ON chat_messages (room_id, created_at DESC);"))
        ...
        db.execute(text("ALTER TABLE user_reputation ADD COLUMN IF NOT EXISTS emergency_score FLOAT DEFAULT 0.0;"))
        db.execute(text("ALTER TABLE user_reputation ADD COLUMN IF NOT EXISTS volunteer_score FLOAT DEFAULT 0.0;"))
        db.execute(text("ALTER TABLE user_reputation ADD COLUMN IF NOT EXISTS business_score FLOAT DEFAULT 0.0;"))
        db.execute(text("ALTER TABLE user_reputation ADD COLUMN IF NOT EXISTS government_trust_score FLOAT DEFAULT 0.0;"))
        ...
        db.execute(text("ALTER TABLE user_reputation ADD COLUMN IF NOT EXISTS reputation_score FLOAT DEFAULT 0.0;"))
        db.execute(text("ALTER TABLE user_reputation ADD COLUMN IF NOT EXISTS tier_badge VARCHAR DEFAULT 'Bronze';"))
        db.execute(text("ALTER TABLE user_reputation ADD COLUMN IF NOT EXISTS verification_level VARCHAR DEFAULT 'Citizen';"))
        db.execute(text("ALTER TABLE user_reputation ADD COLUMN IF NOT EXISTS achievements VARCHAR DEFAULT '[]';"))
        db.execute(text("ALTER TABLE user_reputation ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE;"))
        
        db.execute(text("ALTER TABLE profiles ADD COLUMN IF NOT EXISTS reward_points INTEGER DEFAULT 0;"))
        db.execute(text("ALTER TABLE profiles ADD COLUMN IF NOT EXISTS volunteer_hours INTEGER DEFAULT 0;"))
        db.execute(text("ALTER TABLE profiles ADD COLUMN IF NOT EXISTS emergency_score INTEGER DEFAULT 0;"))
        db.execute(text("ALTER TABLE profiles ADD COLUMN IF NOT EXISTS news_posted INTEGER DEFAULT 0;"))
        db.execute(text("ALTER TABLE profiles ADD COLUMN IF NOT EXISTS last_active_date DATE;"))
        db.execute(text("ALTER TABLE profiles ADD COLUMN IF NOT EXISTS streak_days INTEGER DEFAULT 0;"))
        
        db.execute(text("ALTER TABLE users ADD COLUMN IF NOT EXISTS mid VARCHAR;"))
        db.execute(text("ALTER TABLE users ADD COLUMN IF NOT EXISTS username VARCHAR;"))
        db.execute(text("ALTER TABLE users ADD COLUMN IF NOT EXISTS display_name VARCHAR;"))
        db.execute(text("ALTER TABLE users ADD COLUMN IF NOT EXISTS username_required BOOLEAN DEFAULT false;"))
        db.execute(text("ALTER TABLE users ADD COLUMN IF NOT EXISTS login_provider VARCHAR DEFAULT 'email';"))
        db.execute(text("ALTER TABLE users ADD COLUMN IF NOT EXISTS role_id INTEGER;"))
        db.execute(text("ALTER TABLE users ADD COLUMN IF NOT EXISTS failed_login_attempts INTEGER DEFAULT 0;"))
        db.execute(text("ALTER TABLE users ADD COLUMN IF NOT EXISTS locked_until TIMESTAMP WITH TIME ZONE;"))
        db.execute(text("ALTER TABLE users ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE;"))
        db.commit()
