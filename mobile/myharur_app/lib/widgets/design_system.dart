...
class MHButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (TestConfig.isLuxuryUiTestBuild) {
      final gradient = isSecondary 
          ? null 
          : const LinearGradient(
              colors: [Color(0xFFDD0200), Color(0xFF8B0000)],
              begin: Alignment.topLeft,
              end: Alignment.bottomRight,
            );
      final color = isSecondary ? Colors.white.withOpacity(0.06) : null;
      final textColor = Colors.white;
      final borderColor = isSecondary ? LuxuryColors.racingRed.withOpacity(0.4) : Colors.white.withOpacity(0.2);
      ...
      return Container(
        decoration: BoxDecoration(
          ...
          boxShadow: isSecondary || isDisabled ? null : [
            BoxShadow(color: LuxuryColors.racingRed.withOpacity(0.4), blurRadius: 20, offset: const Offset(0, 6)),
          ],
        ),
        child: Material(
              ...
              child: isLoading
                  ...
                  : Row(
                      ...
                      children: [
                        ...
                        Text(text, style: TextStyle(color: textColor, fontWeight: FontWeight.bold, fontSize: 16, letterSpacing: 0.3)),
                      ],
                    ),
            ),
          ),
      ...
      children: [
        Text(
          ...
          style: TextStyle(
            ...
            fontSize: 14,
            color: TestConfig.isLuxuryUiTestBuild ? LuxuryColors.primaryText : null,
          ),
        ),
        ...
        TextField(
          ...
          style: TextStyle(
            color: TestConfig.isLuxuryUiTestBuild ? LuxuryColors.primaryText : Theme.of(context).colorScheme.onSurface,
          ),
          decoration: InputDecoration(
            hintText: hint,
            hintStyle: TextStyle(
              color: TestConfig.isLuxuryUiTestBuild ? LuxuryColors.secondaryText : Theme.of(context).colorScheme.onSurface.withOpacity(0.5),
            ),
            filled: true,
            fillColor: TestConfig.isLuxuryUiTestBuild 
    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: BackdropFilter(
          ...
          child: Container(
            decoration: BoxDecoration(
              color: showRedGlow ? LuxuryColors.redGlass : LuxuryColors.glassLevel2,
              borderRadius: BorderRadius.circular(22),
              border: Border.all(
                color: showRedGlow 
                    ? LuxuryColors.racingRed.withOpacity(0.40) 
                    : LuxuryColors.glassBorder,
                width: 1.2,
              ),
            ),
            child: Stack(
              children: [
                // Top Specular Highlight Line (High-Isomorphism Detail)
                Positioned(
                  top: 0,
                  left: 16,
                  right: 16,
  ...
  Widget build(BuildContext context) {
    if (TestConfig.isLuxuryUiTestBuild) {
      return Container(
        ...
        decoration: BoxDecoration(
          color: LuxuryColors.deepBackground.withOpacity(0.92),
          borderRadius: const BorderRadius.vertical(top: Radius.circular(28)),
          border: Border(
            top: BorderSide(color: LuxuryColors.racingRed.withOpacity(0.4), width: 1.5),
          ),
          boxShadow: [
            BoxShadow(
              color: LuxuryColors.racingRed.withOpacity(0.25),
              blurRadius: 30,
...
class MHBadge extends StatelessWidget {
  ...
  const MHBadge({super.key, required this.text, this.color, this.icon});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          if (icon != null) ...[Icon(icon, size: 14, color: activeColor), SizedBox(width: 4)],
          Text(text, style: TextStyle(color: activeColor, fontSize: 11, fontWeight: FontWeight.w700)),
        ],
      ),
    );
  }
...
class MHTagChip extends StatelessWidget {
  ...
  const MHTagChip({super.key, required this.label, this.color});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Text(label, style: TextStyle(color: activeColor, fontWeight: FontWeight.w600, fontSize: 12)),
    );
  }
}
