      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: const Icon(Icons.store_mall_directory_outlined, size: 60, color: AppTheme.accent),
          ),
                      ...
                      Row(
                        children: [
                          if (cat != null) ...[
                            ...
                            Container(width: 3, height: 3, decoration: const BoxDecoration(color: AppTheme.textSecondary, shape: BoxShape.circle)),
                            const SizedBox(width: 8),
                          ],
                          Container(
        ...
        children: [
          ...
          Expanded(
            child: _products.isEmpty
                ? const Center(child: Text('No products yet. Add your first product!', style: TextStyle(color: AppTheme.textSecondary)))
                : ListView.builder(
                    controller: scroll,
                    padding: const EdgeInsets.symmetric(horizontal: 20),
                    ...
                    itemBuilder: (ctx, i) {
                      ...
                      return ListTile(
                        leading: Container(
                          ...
                          child: const Icon(Icons.inventory_2_rounded, color: AppTheme.accent, size: 20),
                        ),
        ...
        children: [
          ...
          Expanded(
            child: _offers.isEmpty
                ? const Center(child: Text('No offers yet.', style: TextStyle(color: AppTheme.textSecondary)))
                : ListView.builder(
                    controller: scroll,
                    padding: const EdgeInsets.symmetric(horizontal: 20),
